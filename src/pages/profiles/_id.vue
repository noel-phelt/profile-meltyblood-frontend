        ...
        <div class="">
          ...
          <div class="caption">
            ...
            <modal
              ...
              :contentList="communicationToolList"
    ...
    getProfile() {
      this.$axios
        ...
        .then((response) => {
          ...
          this.character.id = response.data.main_character;
          this.communicationToolList = response.data.communication_tool;
          this.playTimeWeekend = response.data.playtime_weekend;
        });
    },
  },
  mounted() {
